...
create table Fecha_Charlas(
 ...
 --Mensaje de error: Instrucción INSERT en conflicto con la restricción CHECK 'CK_Charlas_votoTotal'. El conflicto ha aparecido en la base de datos 'Potencial_Digital_SQL', tabla 'dbo.Charlas', column 'votoTotal'.
...
-- En idCharla nos da el siguiente error poruqe es on delete no action y en las demas on delete cascade:Mens. 547, Nivel 16, Estado 0, Línea 154
-- Instrucción DELETE en conflicto con la restricción REFERENCE 'FK_Pontentes_Charlas'. El conflicto ha aparecido en la base de datos 'Potencial_Digital_SQL2', tabla 'dbo.Ponentes', column 'idCharla'.
